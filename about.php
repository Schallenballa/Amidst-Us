...
echo "<h3><a class='button' href='members.php?view=$user'>Home</a></h3>";
echo "<ul><li>Home shows you your profile and allows you to click a button to view your messages</li></ul>";
echo "<h3><a class='button' href='members.php'>Members</a></h3>";
echo "<ul><li>Members shows a list of all the current members of the site. You can click on their names to follow them or leave a message</li></ul>";
